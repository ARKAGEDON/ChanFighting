...
using Mirror;
    ...
    public class NetworkRoomPlayerChan : NetworkBehaviour
    {
        static readonly ILogger logger = LogFactory.GetLogger(typeof(NetworkRoomPlayerChan));
        ...
        public void Start()
        {
            if (NetworkManager.singleton is NetworkManagerLobbyChan room)
            {
        ...
        public void CmdChangeReadyState(bool readyState)
        {
            ...
            NetworkManagerLobbyChan room = NetworkManager.singleton as NetworkManagerLobbyChan;
            if (room != null)
            {
