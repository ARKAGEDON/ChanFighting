...
using Mirror; 
    ...
    /// </remarks>
    public class NetworkManagerLobbyChan : NetworkManager
    {
        static readonly ILogger logger = LogFactory.GetLogger(typeof(NetworkManagerLobbyChan));
        ...
        protected NetworkRoomPlayerChan roomPlayerPrefab;
        ...
        public List<NetworkRoomPlayerChan> roomSlots = new List<NetworkRoomPlayerChan>();

		[Header("ChanPrefabs")]
		public GameObject UnityChanPrefab;
		public GameObject PrototypeChanPrefab;
		public ChanManager _PlayerData;
        ...
        internal void ReadyStatusChanged()
        {
            ...
            foreach (NetworkRoomPlayerChan item in roomSlots)
            {
                if (item != null)
                {
                    CurrentPlayers++;
        ...
        public override void OnServerReady(NetworkConnection conn)
        {
            ...
            if (conn != null && conn.identity != null)
            {
                ...
                if (roomPlayer != null && roomPlayer.GetComponent<NetworkRoomPlayerChan>() != null)
        ...
        void SceneLoadedForPlayer(NetworkConnection conn, GameObject roomPlayer)
        {
            ...
            if (gamePlayer == null)
            {
				//Fonction pour changer le type de chan
                ...
                gamePlayer = startPos != null
                    ...
                    : Instantiate(ChanPrefab, Vector3.zero, Quaternion.identity);
            }
        ...
        public void CheckReadyToBegin()
        {
            ...
            int numberOfReadyPlayers = NetworkServer.connections.Count(conn => conn.Value != null && conn.Value.identity.gameObject.GetComponent<NetworkRoomPlayerChan>().readyToBegin);
        ...
        {
            OnRoomClientEnter();
            foreach (NetworkRoomPlayerChan player in roomSlots)
                if (player != null)
                {
        ...
        public override void OnServerDisconnect(NetworkConnection conn)
        {
            ...
            {
                NetworkRoomPlayerChan roomPlayer = conn.identity.GetComponent<NetworkRoomPlayerChan>();
                ...
                {
                    roomPlayer = clientOwnedObject.GetComponent<NetworkRoomPlayerChan>();
                    if (roomPlayer != null)
                        roomSlots.Remove(roomPlayer);
                }
            }
            ...
            {
                if (player != null)
                    player.GetComponent<NetworkRoomPlayerChan>().readyToBegin = false;
            }
        ...
        public override void ServerChangeScene(string newSceneName)
        {
            ...
            {
                foreach (NetworkRoomPlayerChan roomPlayer in roomSlots)
                {
                    if (roomPlayer == null)
                        continue;
                    ...
                    if (NetworkServer.active)
                    {
                        ...
                        roomPlayer.GetComponent<NetworkRoomPlayerChan>().readyToBegin = false;
